...
const dbManager = require('../db/unmManager');

/**
 * @type {import('../db/unmManager').Student[]}
 */
const students = [];
...
/**
 * @type {import('../db/unmManager').WeekSchedule}
 */
let schedule1 = {
    classNo: 2,
    posX: 1,
...
test('야자 출석 현황 확인 - 모든 학생', async () => {
    /**
     * @type {import('../db/unmManager').attendanceInfoQueryOptions}
     */
